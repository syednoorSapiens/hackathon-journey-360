...
The form will be fully functional with all configurations applied. You can refine it further using prompts below or switch to Manual mode for detailed customization.`,
  ...
  const handleSubmit = () => {
    ...
    const userMessage: Message = {
      role: "user",
      content:
        currentPrompt.trim() || `[Attached ${attachments.length} file(s)]`,
      timestamp: new Date(),
    };
                ...
                {message.role === "assistant" && (
                  <div className='flex items-center gap-1.5 mb-2 pb-1.5 border-b border-border/50'>
                    ...
                    >
                      ...
                      />
                      <path
                        d='M70.7585 6.92022C78.3515 5.46052 85.6904 10.4327 87.1501 18.0257C88.6096 25.6185 83.6375 32.9566 76.0447 34.4163C52.6446 38.9149 34.8387 56.4251 29.5847 80.4886C27.9354 88.0426 20.4746 92.8293 12.9206 91.18C5.36661 89.5307 0.579906 82.0699 2.22922 74.5159C9.80122 39.8357 36.0349 13.5958 70.7585 6.92022Z'
                        fill='#7C54EC'
                      />
                      <path
      ...
      <div className='border-t border-border bg-background px-3 py-2'>
        ...
        <div className='relative flex items-center gap-1.5 bg-card border border-border rounded-[var(--radius-input)] p-1.5 focus-within:border-foreground transition-colors'>
          ...
          <Button
            ...
            disabled={
              isProcessing ||
              (!currentPrompt.trim() && attachments.length === 0)
            }

...
const TravelInsuranceFormGlassComponent = ({
  ...
  const currentStep =
    externalWizardStep !== undefined ? externalWizardStep : internalStep;
        ...
        >
          ...
          >
            ...
            >
              <h2
                className={
                  templateStyle === "creative" ? "" : "text-foreground"
                }
                style={{
                  color:
              ...
              <p
                className={
                  templateStyle === "creative" ? "" : "text-muted-foreground"
                }
                style={{
                  color:
                    templateStyle === "creative"
            ...
            >
              <div className='flex flex-col gap-1 sm:flex-row sm:justify-between sm:items-center sm:gap-4 min-w-0'>
                <span
                  className={
                    templateStyle === "creative"
                      ...
                      : "text-muted-foreground flex items-center gap-2 flex-shrink-0"
                  }
                  style={{
                    color:
                      templateStyle === "creative"
                ...
                <span
                  className={
                    templateStyle === "creative"
                      ? "capitalize break-words sm:text-right min-w-0 overflow-wrap-anywhere"
                      : "text-foreground capitalize break-words sm:text-right min-w-0 overflow-wrap-anywhere"
                  }
                  style={{
      ...
      return (
        ...
        >
          <div className='flex justify-between items-center'>
            <span
              className={templateStyle === "creative" ? "" : "text-foreground"}
              style={{
                color: templateStyle === "creative" ? "#ffffff" : undefined,
              }}
            >
          ...
          {steps.map((step, index) => (
            <React.Fragment key={index}>
              ...
              <div className='flex flex-col items-center gap-2 relative z-10'>
                ...
                <span
                  className={`text-xs text-center max-w-[80px] hidden sm:block ${
                    index === currentStep
                      ? "text-foreground"
                      : "text-muted-foreground"
                  }`}
  ...
  const renderStep1 = () => (
    ...
    >
      ...
      <div
        ...
        style={{
          borderRadius:
            templateStyle === "creative" ? "32px" : getInputBorderRadius(),
          padding:
            templateStyle === "creative"
              ? "24px 16px"
              : spacing === "compact"
      ...
      >
        ...
        <div className='bg-[rgba(0,0,0,0)]'>
          <h3
            className={
              templateStyle === "creative" ? "mb-1" : "mb-1 text-foreground"
            }
            style={{
              color:
                templateStyle === "creative"
          ...
          >
            ...
            <h4
              className={
                templateStyle === "creative"
                  ? "mb-1 relative z-10"
                  : "text-foreground mb-1 relative z-10"
              }
              style={{
                color:
                  templateStyle === "creative"
    ...
    >
      ...
      <StepContentWrapper>
        <div>
          <Label
            className={
              templateStyle === "creative" ? "mb-3" : "text-foreground mb-3"
            }
            style={{
              color:
                templateStyle === "creative"
                ...
                style={{
                  borderRadius:
                    templateStyle === "creative"
                      ...
                      : getInputBorderRadius(),
                  padding:
                    templateStyle === "creative" ? "24px 16px" : undefined,
                  borderColor:
  ...
  console.log("templateStyle===>", templateStyle, isDarkMode);
  return (
    <div
    ...
    >
      ...
      {templateStyle === "professional" && (
        <div className='absolute inset-0 pointer-events-none overflow-hidden'>
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, color-mix(in srgb, var(--accent) 8%, transparent) 0%, color-mix(in srgb, var(--primary) 5%, transparent) 40%, transparent 100%)",
            }}
          />
        </div>
      )}
      ...
      <div
        ...
        style={{
          maxWidth:
            templateStyle === "professional" ? "100%" : getContainerMaxWidth(),
        }}
      >
            ...
            style={{
              ...
              backgroundColor:
                templateStyle === "professional"
                  ...
                  : "var(--card)",
              backdropFilter:
                templateStyle === "professional" || templateStyle === "creative"
                  ? "blur(20px)"
                  : undefined,
                ...
                <div className='text-center md:text-left flex-1'>
                  ...
                  <h2
                    ...
                    style={{
                      ...
                      color:
                        templateStyle === "creative" ? "#ffffff" : undefined,
                      marginBottom: "0.5rem",
                    }}
                  >
